...
| [mechanical/](mechanical/) | Mechanical parts: STEP files, BOM / 機構部品：STEP データ、部品表 |
...
CERN-OHL-S-2.0 で公開しています（他者の EAGLE ライブラリ要素と購入部品の 3D モデルを除く）。[LICENSE.md](../LICENSE.md) を参照してください。
